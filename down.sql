...
CREATE TABLE `eventprecondition` (
    ...
    `updatedAt` DATETIME(3) NOT NULL,
    `image_id` INTEGER NOT NULL,
    `event_precondition_description_id` INTEGER NOT NULL,

    INDEX `EventPrecondition_event_participant_id_fkey`(`event_participant_id` ASC),
    INDEX `EventPrecondition_event_precondition_description_id_fkey`(`event_precondition_description_id` ASC),
